...
public class SelecaoNeurotech {
	...
	@Before //inicializa antes de cada execução;
...
//	}
//	
//	//favor executar a segunda vez caso de erro na primeira execução;
//	@Test
...
//	
//
//       // Thiago Brayner, vou ficar devendo o print, pq não sei tirar o print só de um metodo, uso 
//	   //o screenshot que tira os prints em execução;
//	
//	@Test
